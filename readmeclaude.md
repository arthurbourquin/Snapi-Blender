...
Vectos &emsp;$\vec{u} = \overrightarrow{AB} \quad;\quad \vec{v} = \overrightarrow{AC}$
...
&emsp;;&emsp;
$\mathbf{b} = \begin{bmatrix}\lambda \\ \delta\end{bmatrix}$
&emsp;;&emsp;
$\mathbf{s} = \begin{bmatrix}\vec{w} \vec{u} \\ \vec{w} \vec{v}\end{bmatrix}$
&emsp;;&emsp;
